        ...
        <div className="articles-container">
          ...
          <article className="card">
            ...
            <div>
              ...
              <h3>
                <Link to="/article/1">Magnetotherapy in horses</Link>
              </h3>
              <p>
                Lorem ipsum dolor sit amet consectetur adipisicing elit. Quaerat
                hic vero vel ipsam rerum. Quisquam quia labore laborum autem.
                Aliquid?
              </p>
            </div>
          </article>
          ...
          <article className="card">
            ...
            <p>
              ...
              Rem sunt eligendi laboriosam inventore accusamus in?
            </p>
          </article>
          <article className="card">
